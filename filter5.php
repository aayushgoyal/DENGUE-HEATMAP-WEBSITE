...
$alat=array();
$alng=array();
$query1="select world_cities_table.lat from world_cities_table, patient_details where world_cities_table.city=patient_details.City AND patient_details.Sex='female'";
$query2="select world_cities_table.lng from world_cities_table, patient_details where world_cities_table.city=patient_details.City AND patient_details.Sex='female'";
